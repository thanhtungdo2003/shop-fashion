...
import { Box, Contact, Facebook, LogOutIcon, Phone, PhoneCall, Search, SearchCheckIcon, Settings2Icon, ShoppingBagIcon, User, UserCog2Icon, UserCogIcon, UserPen, X, Youtube } from "lucide-react";

import Swal from "sweetalert2";
import Slideshow from "./SlideShow";
import slide1 from "../lib/slide1.png";
import slide2 from "../lib/slide2.png";
import slide3 from "../lib/slide3.png";
import slide4 from "../lib/slide4.png";
import slide5 from "../lib/slide5.png";
                        ...
                        <div className="user-nav" style={{ margin: "auto 10px", display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", position: "relative" }}>
                            ...
                            <div style={{ width: "130px", height: "50px", cursor: "pointer" }} onClick={() => { setUserMenuStage(userMenuStage === "hide" ? "show" : "hide") }}>
                                <div style={{ height: "25px", display: "flex", gap: "5px", alignItems: "center" }}>
                                    <p style={{ color: "rgb(255, 255, 255)", fontWeight: "550" }}>Toài khoản</p>
                                ...
                                <div style={{ height: "25px", fontSize: "14px", color: "rgb(252, 252, 252)" }}>
                                    {userData.username}
                                </div>
                            </div>
                            ...
                            <div className="nav-header">
                                <div className="nav-container">
                                    <div className="nav-left">
                                        <ul>
                                            <li><a href="/vegetables-graden">TRANG CHỦ</a></li>
